...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.0.0"])
      s.add_runtime_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<cocoapods-deintegrate>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, ["< 2.0", ">= 1.0.0"])
      ...
      s.add_runtime_dependency(%q<cocoapods-trunk>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<cocoapods-try>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<molinillo>.freeze, ["~> 0.4.5"])
      s.add_runtime_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.0.0"])
      ...
      s.add_runtime_dependency(%q<fourflusher>.freeze, ["~> 0.3.0"])
      s.add_runtime_dependency(%q<nap>.freeze, ["~> 1.0"])
      s.add_development_dependency(%q<bacon>.freeze, ["~> 1.1"])
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.3"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.0"])
    else
      s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.0.0"])
      s.add_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<cocoapods-deintegrate>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<cocoapods-downloader>.freeze, ["< 2.0", ">= 1.0.0"])
      ...
      s.add_dependency(%q<cocoapods-trunk>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<cocoapods-try>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<molinillo>.freeze, ["~> 0.4.5"])
      s.add_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<activesupport>.freeze, [">= 4.0.2"])
      s.add_dependency(%q<colored>.freeze, ["~> 1.2"])
      s.add_dependency(%q<escape>.freeze, ["~> 0.0.4"])
      s.add_dependency(%q<fourflusher>.freeze, ["~> 0.3.0"])
